...
for (let i = 0; i < activeNewStaff.length; i++) {
    if (activeNewStaff[i].age < 20)
        activeNewStaff[i].salary += 50000;
    else if (activeNewStaff[i].age < 30)
        activeNewStaff[i].salary += 100000;
    else if (activeNewStaff[i].age < 40)
        activeNewStaff[i].salary += 150000;
    else
        activeNewStaff[i].salary += 200000;
}
